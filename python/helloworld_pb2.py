...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x10helloworld.proto\x12\x08gRPCDemo\"\x1c\n\x0cHelloRequest\x12\x0c\n\x04name\x18\x01 \x01(\t\"\x1d\n\nHelloReply\x12\x0f\n\x07message\x18\x01 \x01(\t2\x83\x01\n\x04gRPC\x12:\n\x08SayHello\x12\x16.gRPCDemo.HelloRequest\x1a\x14.gRPCDemo.HelloReply\"\x00\x12?\n\rSayHelloAgain\x12\x16.gRPCDemo.HelloRequest\x1a\x14.gRPCDemo.HelloReply\"\x00\x62\x06proto3'
)
...
_GRPC = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SayHelloAgain',
    full_name='gRPCDemo.gRPC.SayHelloAgain',
    index=1,
    containing_service=None,
    input_type=_HELLOREQUEST,
    output_type=_HELLOREPLY,
